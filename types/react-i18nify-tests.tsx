...
<Localize value="11-11-2019" dateFormat="mm/dd/YYYY" parseFormat="mm-dd-YYYY" />;
...
setTranslationsGetter(() => ({ foo: 'bar' })); // $ExpectType void
setTranslationsGetter(() => 'asdf'); // $ExpectError

setHandleMissingTranslation(() => 'asdf'); // $ExpectType void
setHandleMissingTranslation((key: string) => 'asdf'); // $ExpectType void
// $ExpectType void
setHandleMissingTranslation((key: string, replacements: Replacements) => 'asdf');
